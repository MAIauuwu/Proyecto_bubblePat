...
public class DogApiService {
    ...
    public BreedImageDTO getRandomImageByBreed(String breed) {
        ...
        String url = imageCache.get("dog:breed:" + breed.toLowerCase(), () -> fetchBreedImageUrl(breed));
        return url != null ? dto(url, breed) : null;
    }

    public BreedImageDTO getRandomImage() {
        String url = imageCache.get("dog:random", this::fetchRandomImageUrl);
        return url != null ? dto(url, "perro") : null;
    }
    ...
    @SuppressWarnings("unchecked")
    private String fetchRandomImageUrl() {
        try {
    ...
    @SuppressWarnings("unchecked")
    private String fetchBreedImageUrl(String breed) {
        try {
        ...
        // Si no se encuentra la raza o falla, devolvemos un perro aleatorio.
        return fetchRandomImageUrl();
    }
